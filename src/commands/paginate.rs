// template is local impl of from poise::builtins::paginate
...
pub async fn paginate(
    ...
    // Send the embed with the first page as content and store the reply handle
    let reply = ctx
        .send(
    ...
    while let Some(press) = serenity::collector::ComponentInteractionCollector::new(ctx)
        ...
        .timeout(std::time::Duration::from_secs(7200 * 2))
        .await
    {
